...
Open http://127.0.0.1:5173 — home → build wizard (steps 1–7) or **import text file** (download template on home); review → generate → deck view (`/deck/:id`) with dependency dashboard; saved decks at `/library`. Production bundle:
