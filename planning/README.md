...
| [11-dependency-engine-user-experience.md](11-dependency-engine-user-experience.md) | **Active** — user control, focus presets, feedback; UX2–UX3 wizard shipped; UX5+ planned |
...
**Recommended first tasks:** **UX5** local web dependency dashboard ([11-dependency-engine-user-experience.md](11-dependency-engine-user-experience.md)); threshold tuning per doc 15.
