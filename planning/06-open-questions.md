...
| Topic | Notes |
| --- | --- |
| Dependency wizard UX (UX4+) | UX3 shipped (criteria linter preflight); UX4–UX5 wizard navigation/prepopulate next; UX7+ local web — [11-dependency-engine-user-experience.md](11-dependency-engine-user-experience.md) |
