...
| Topic | Notes |
| --- | --- |
| Dependency wizard UX (UX7+) | UX2–UX5 CLI wizard shipped; UX7+ local web next — [11-dependency-engine-user-experience.md](11-dependency-engine-user-experience.md) |
