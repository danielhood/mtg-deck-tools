...
| --- | --- | --- | --- | --- | --- |
| **UX7** | web-ui | Cross-platform web shell (mobile-first); ~~**UX7c** build wizard~~ ~~**UX7e** deck view~~ **shipped** — **UX7f** library, **UX7d** dashboard — [specs/web/README.md](../specs/web/README.md), [architecture.md](../specs/web/architecture.md) | **Selected — P1** | UX7e shipped | **ENG-MAINT**, doc-only |
