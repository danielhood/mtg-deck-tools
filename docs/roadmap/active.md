...
| --- | --- | --- | --- | --- | --- |
| **UX7** | web-ui | Cross-platform web shell (mobile-first); **UX7c-a** wizard API + steps 1–7 (**WIP**) — then UX7c-b review/result, UX7e view, UX7f library, UX7d dashboard — [specs/web/README.md](../specs/web/README.md), [architecture.md](../specs/web/architecture.md) | **Selected — P1** | UX7a–UX7b shipped (`service/`, `api/`, `serve`) | **ENG-MAINT**, doc-only |
