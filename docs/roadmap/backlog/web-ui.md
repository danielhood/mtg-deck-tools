...
| **UX7c** | Build wizard + result | **UX7c-a WIP** (API + steps 1–7) — then c-b review/result, c-c polish; [user-experience.md](../../specs/dependency-engine/user-experience.md) § UX7c |
