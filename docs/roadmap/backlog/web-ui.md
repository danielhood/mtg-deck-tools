...
| **UX7c** | Build wizard + result | **UX7c-a–UX7c-b shipped** (API + steps 1–7 + review/generate/result) — **UX7c-c** polish; [user-experience.md](../../specs/dependency-engine/user-experience.md) § UX7c |
