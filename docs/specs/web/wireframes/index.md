...
| `/deck/:id` (advanced swap) | [deck-view-advanced-swap-sheet.html](deck-view-advanced-swap-sheet.html) | approved | UX12 — bottom sheet + preview |
| `/deck/:id` (issue fix) | [deck-view-issue-fix-strategies.html](deck-view-issue-fix-strategies.html) | approved | UX12 — strategy chips + Fix issue / Quick fix |
| `/deck/:id` (named swap) | [deck-view-named-swap.html](deck-view-named-swap.html) | approved | UX12 — named card search + validation override |
| `/deck/:id` (swap override) | [deck-view-advanced-swap-override.html](deck-view-advanced-swap-override.html) | approved | UX12 — validation override on apply |
