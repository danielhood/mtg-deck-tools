...
Gate for starting **D1+ engine code** (extraction, validation, scoring). Planning direction lives in [10-card-dependency-engine.md](overview.md) and [11-dependency-engine-user-experience.md](user-experience.md); this doc tracks **evidence and contracts** that must exist first.

**Product context:** Static oracle snapshot, used-card audience — [01-goals-and-scope.md](../../product/goals-and-scope.md), [02-data-sources.md](../../architecture/data-sources.md).
...
**Rule:** D0–D5 are **complete** (2026-05-31). Use this checklist for dogfood acceptance and UX2+ work; do not reopen D1 gate unless schema or pattern contracts change. **Post–D5 expansion** (new effect kinds and profiles) — see [15-dependency-expansion-roadmap.md](../../roadmap/dependency-expansion.md).
...
| ☑ | Pattern ID → `effect_kind` mapping documented | `config/effect-patterns.yaml` + [14-effect-extraction-face-policy.md](effect-extraction-policy.md) |
| ☑ | Face policy documented (per `face_index` vs merged oracle; align with `normalize.py`) | [14-effect-extraction-face-policy.md](effect-extraction-policy.md) |
...
Record answers in [13-dependency-engine-decisions.md](decisions.md).
...
| ☐ | Item | Notes / artifact |
| --- | --- | --- |
| ☑ | `dependency_report` JSON schema documented in [07-deck-output-format.md](../../product/deck-output-format.md) | Optional field on schema 1.0 |
...
- [10-card-dependency-engine.md](overview.md) — D0–D5 technical phases
- [11-dependency-engine-user-experience.md](user-experience.md) — UX phases, progressive constraints
- [15-dependency-expansion-roadmap.md](../../roadmap/dependency-expansion.md) — post–D5 expansion backlog
- [09-next-steps.md](../../roadmap/active.md) — backlog
