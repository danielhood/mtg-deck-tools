...
**Rule:** D0–D5 are **complete** (2026-05-31). Use this checklist for dogfood acceptance and UX2+ work; do not reopen D1 gate unless schema or pattern contracts change. **Post–D5 expansion** (new effect kinds and profiles) — see [dependency-expansion.md](../../roadmap/dependency-expansion.md).
...
- [dependency-expansion.md](../../roadmap/dependency-expansion.md) — post–D5 expansion backlog
